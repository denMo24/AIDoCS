...
data <- read.csv("/Users/mosimacnew/Desktop/df_ready_for_prammming/df_cc-pram_pyxisname_mapped_cleaned.csv")
...
write.csv(data_cc_mapped, "data_cc_mapped_pyxisname.csv", row.names = FALSE)

# Confirm the file has been saved
print("data_cc_mapped_pyxis_name.csv has been saved successfully.")
```
